...
namespace MA\RedactorBundle\Form\Type;
...
use MA\RedactorBundle\Model\RedactorService;
...
class RedactorType extends AbstractType
{
    ...
    /**
     * @var \MA\RedactorBundle\Model\RedactorService
     */
    protected $redactorService;

    /**
     * @param \MA\RedactorBundle\Model\RedactorService $redactorService
     */
