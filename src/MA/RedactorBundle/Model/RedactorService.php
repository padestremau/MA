...
namespace MA\RedactorBundle\Model;
...
class RedactorService extends ContainerAware
{
    ...
    {
        return $this->container->getParameter(sprintf('ma_redactor.%s', $envName));
    }
    ...
    {
        $settings = array();
        $config = $this->container->getParameter(sprintf('ma_redactor.%s', $envName));
