...
namespace MA\RedactorBundle\DependencyInjection;
 ...
 */
class MARedactorExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        foreach ($config as $envName => $envConfig) {
            ...
            $container->setParameter(sprintf('ma_redactor.%s', $envName), $envConfig);
        }
